 ...
 * 
 */
package com.brain.study.java.autoclose;
...
public class TestTry {
	...
	static class AutoClose implements AutoCloseable {
		...
		@Override
		public void close() throws IOException { // 接口中定义抛出的异常时Exception 子类不能抛出更多，需要在try后捕获活或抛出处理
	...
	public static void testAutoCloseable() {
		...
		*/
		try (
				AutoClose is1 = new AutoClose("auto 1");
				AutoClose is2 = new AutoClose("auto 2")
			) {
