...
public class PricesInfo {
	...
	public int getPrice1() {
		...
		System.out.println(Thread.currentThread().getName() + "get start price1");
		int temp = price1;
		try {
			Thread.sleep(100);
		...
		System.out.println(Thread.currentThread().getName() + "get end price1=" + price1);
	...
	public int getPrice2() {
		rwLock.readLock().lock();
		System.out.println(Thread.currentThread().getName() + "get start price2");
		int temp = price2;
		try {
			Thread.sleep(100);
		} catch (InterruptedException e) {
		...
		System.out.println(Thread.currentThread().getName() + "get end price2=" + price2);
		rwLock.readLock().unlock();
		return temp;
	}
